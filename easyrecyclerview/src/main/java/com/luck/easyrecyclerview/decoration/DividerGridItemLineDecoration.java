package com.luck.easyrecyclerview.decoration;
 ...
 * @author zhy
 */
public class DividerGridItemLineDecoration extends RecyclerView.ItemDecoration {

    private static final int[] ATTRS = new int[]{android.R.attr.listDivider};
    private Drawable mDivider;
    private int lineWidth = 20;

    public DividerGridItemLineDecoration(Context context) {
        final TypedArray a = context.obtainStyledAttributes(ATTRS);
        mDivider = a.getDrawable(0);
        a.recycle();
    }

    public DividerGridItemLineDecoration(int color) {
        mDivider = new ColorDrawable(color);
    }

    public DividerGridItemLineDecoration() {
